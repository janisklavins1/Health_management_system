...
namespace Management.Data.Migrations
{
    ...
    [Migration("20230316174455_RemovedMaxLengthForPersonFields")]
    partial class RemovedMaxLengthForPersonFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AllergyPerson", b =>
                {
                    ...
                    b.HasKey("AllergiesAllergyId", "PersonsPersonId");
            ...
            modelBuilder.Entity("LabResultLabResultStatus", b =>
                {
                    b.Property<int>("LabResultStatusesLabResultStatusId")
                        .HasColumnType("int");

                    b.Property<int>("LabResultsLabResultId")
                        .HasColumnType("int");

                    b.HasKey("LabResultStatusesLabResultStatusId", "LabResultsLabResultId");

                    b.HasIndex("LabResultsLabResultId");

                    b.ToTable("LabResultLabResultStatus");
                });
            ...
            modelBuilder.Entity("Management.Domain.Models.AllergyPerson", b =>
                {
                    b.Property<int>("AllergyPersonId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AllergyPersonId"));
            ...
            modelBuilder.Entity("Management.Domain.Models.LabResultStatusLabResult", b =>
                {
                    b.Property<int>("LabResultStatusLabResultId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LabResultStatusLabResultId"));
                    ...
                    b.HasKey("LabResultStatusLabResultId");
            ...
            modelBuilder.Entity("Management.Domain.Models.MedicationPerson", b =>
                {
                    b.Property<int>("MedicationPersonId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MedicationPersonId"));
            ...
            modelBuilder.Entity("Management.Domain.Models.VaccinationPerson", b =>
                {
                    b.Property<int>("VaccinationPersonId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("VaccinationPersonId"));
            ...
            modelBuilder.Entity("MedicationPerson", b =>
                {
                    b.Property<int>("MedicationsMedicationId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("MedicationsMedicationId", "PersonsPersonId");
            ...
            modelBuilder.Entity("AllergyPerson", b =>
                {
                    b.HasOne("Management.Domain.Models.Allergy", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LabResultLabResultStatus", b =>
                {
                    b.HasOne("Management.Domain.Models.LabResultStatus", null)
                        .WithMany()
                        .HasForeignKey("LabResultStatusesLabResultStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Management.Domain.Models.LabResultStatusLabResult", b =>
                {
                    ...
                    b.HasOne("Management.Domain.Models.LabResultStatus", "LabResultStatus")
                        .WithMany()
                        .HasForeignKey("LabResultStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
